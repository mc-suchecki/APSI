...
\begin{enumerate}
\item[1-4.] Jak w~scenariuszu głównym.
\item[5.] Użytkownik nacisnął przycisk ,,Anuluj''.
\item[6.] System powraca do strony ,,Profil''.
\end{enumerate}
...
\begin{enumerate}
\item[1-4.] Jak w~scenariuszu głównym.
\item[5.] System wyświetla informację o~wykrytym błędzie.
\item[6.] Użytkownik poprawia hasło i~naciska przycisk ,,Usuń''.
